...
import infer_fn_v4_insta as infer
...
if __name__ == '__main__':
    ...
    data_root = os.path.join(root, '3_Datasets', 'InstaPIC1M')
    log_root = os.path.join(root, '1_TF_files', 'caption_baseN', 'insta_v4')
    ...
    annotations_file = 'annotations/captions_insta_test1.json'
