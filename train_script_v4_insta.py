...
if __name__ == '__main__':
    ...
    data_root = pjoin(root, '3_Datasets', 'InstaPIC1M')
    ...
    #cnn_checkpoint_path = pjoin(cnn_root, 'inception_v3.ckpt')
    ...
    if lang_model == 'char':
        ...
        itow_file = 'captions/insta_LEGACY_char_itow_%s.json' % file_suffix
        wtoi_file = 'captions/insta_LEGACY_char_wtoi_%s.json' % file_suffix
        caption_file = 'captions/insta_LEGACY_char_%s.h5' % (file_suffix)
        base = None
    else:
        file_suffix = 'v25595_s18_split'
        itow_file = 'captions/insta_LEGACY_itow_%s.json' % file_suffix
        wtoi_file = 'captions/insta_LEGACY_wtoi_%s.json' % file_suffix
        if lang_model == 'baseN':
            caption_file = 'captions/insta_LEGACY_base%d_%s.h5' % (args.base, file_suffix)
        elif lang_model == 'word':
            caption_file = 'captions/insta_LEGACY_%s.h5' % (file_suffix)
            base = None
